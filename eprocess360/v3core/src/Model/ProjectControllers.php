 ...
 */
class ProjectControllers extends Model
{
    /**
     * @return Table
     */
    ...
    {
        return Table::build(
            PrimaryKeyInt::build('idController', 'Controller ID')->joinsOn(Controllers::model()),
            FixedString256::build('description', 'Controller Description'),
            TinyInteger::build('itemOrder', 'Item Order'),
            BitString::build('moduleStatus', 'Module Status')
        )->setName('ProjectControllers');
    }
