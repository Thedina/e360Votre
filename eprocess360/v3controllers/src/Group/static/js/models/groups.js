...
/**
 * Backbone model for user groups
 * @typedef {Object} GroupModel
 */
var GroupModel = BizzyBone.BaseModel.extend({
    urlRoot: hbInitData().meta.Group.apiPath,
    idAttribute: 'idGroup',
    defaults: {
        idController: 0,
        title: '',
...
/**
 * A list of GroupModels
 * @typedef {Object} GroupList
 */
var GroupList = BizzyBone.BaseCollection.extend({
    model: GroupModel,
    url: hbInitData().meta.Group.apiPath,
    /**
